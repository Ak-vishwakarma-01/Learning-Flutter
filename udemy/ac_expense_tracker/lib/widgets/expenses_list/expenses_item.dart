...
class ExpensesItem extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Card(      // it looks like card and it autmatically add some top and bottom margin and some design
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Row(children: [
              Text('₹${expense.amount.toStringAsFixed(2)}'),  // it will print upto 2 decimal values only
